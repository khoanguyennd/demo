<?php include_once(PATH_APPLICATION . 'view/popup/register_member.php') ?>
                            ...
                            <div class="w-85 m-auto m-0 pl-5 pr-5">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control from-c use-keyboard-number" autocomplete="off" id="editPhonelistmember" name="phone" onkeyup="this.value=this.value.replace(/[^\d]/,'')" placeholder="<?= $this->language("l_phone_placeholder") ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
