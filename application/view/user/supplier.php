			...
			<form action="<?=$this->route('supplier')?>" method="POST" id="frmuser"
						...
						<div class="row rmclass" data-action="viewperson" data-perid="14">
							...
							<div class="form_group clearfix">
								...
								<div class="form_item col-xs-3 align-left">
									...
									<input type="radio" name="usage" <?php if($usage==1) echo 'checked="checked"'; ?> id="checkusage1"  value="1" style="margin: 10px 0px 0px 0px;">
        							<label for="checkusage1">사용</label>
        							<input type="radio" name="usage" <?php if($usage==0) echo 'checked="checked"'; ?> id="checkusage0" value="0" style="margin: 10px 0px 0px 10px;">
        							<label for="checkusage0">미사용</label>
				...
				<div class="forminput">
					<div class="form_group clearfix frrow">
						...
						<div class="form_group clearfix"></div>
					</div>
			...
			<div class="form_group clearfix frrow">
				<div class="row rmclass" data-action="viewperson" data-perid="14">
					...
					<div class="form_group clearfix">
						...
						<div class="form_item col-xs-3 align-left" >
							<input type="radio" name="checkparking" <?php if($parking==0) echo 'checked="checked"'; ?> id="checkparking0"  value="0" style="margin: 10px 0px 0px 0px;"
							...
							<input type="radio" name="checkparking" <?php if($parking==1) echo 'checked="checked"'; ?> id="checkparking1" value="1" style="margin: 10px 0px 0px 10px;"
