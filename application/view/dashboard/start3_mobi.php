        ...
        <div class="<?=$class?> paddingleftright">
            <div class="bgt-blue mb-3">
                ...
                <div class="<?=$s_p_m?> t-line b-line">
                    <div style="position: relative;" class="start_player_diem start_player_diem_color-<?=$class_point?> s-160 w-275 h-275 <?=$c_p_m?>">
                ...
                <div class="start_player_history t-line">
                    <div class="title_history">
                        <div class="row" style="margin-left: 0px; margin-right: 0px;">
                            <div class="col-md-12 paddingleftright5 text-left">
