...
<div class="container-fluid">
    <div class="main-bgt mt-3" style="padding: 10px 20px !important">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="mt-4 float-right pt-1" style="width: 50%; margin-top: 0px !important;">
            ...
            <div class="bgt-blue mb-3">
                <div class="star-player-top b-line pt-2 pb-0 pl-4">
                    <div class="row">
                        ...
                        <div class="w-10 pl-0 float-right">
                            <div class="diem-chap-tv text-center s-50" style="margin-left: -20px">
                ...
                <div class="star-player-main t-line b-line pt-5">
                    <div class="start_player_diem start_player_diem_color-<?=$class_point?> s-160 w-275 h-275">
                        ...
                        <p class="pointusernow<?= $i ?>" onclick="addpoint('<?= $i ?>', '<?= $thanhvien_name ?>', '<?= $thanhvien_diemketthuc ?>', '<?= $trandau_id ?>', '<?= $thanhvien_trandau_id ?>')">
                            <span id="point">
                                <?php
                ...
                <div class="start_player_history t-line">
                    ...
                    <div style="min-height: 330px;max-height: 330px;height: 100%;" class="main_history">
...
<style>
    .button_play {background: #cb7309; border: #f69929 1px solid; box-shadow: #000 0px 6px 8px; font-size: 20px; text-transform: uppercase;border-radius: 10px; padding: 8px 10px; margin: 0 5px; font-family: utm avo; font-weight: 500; color: #fff; width: 100%;}
    .button_play:hover {background-color: #d39e00;border-color: #c69500;}
    .button_continue {display: none;background: #cb7309; border: #f69929 1px solid; box-shadow: #000 0px 6px 8px; font-size: 20px; text-transform: uppercase;border-radius: 10px; padding: 8px 10px; margin: 0 5px; font-family: utm avo; font-weight: 500; color: #fff; width: 100%;}
    .button_continue:hover {background-color: #d39e00;border-color: #c69500;}
    .button_pause35,.button_stop3 {background: #0261b1; border: #0485e9 1px solid; box-shadow: #000 0px 6px 8px; font-size: 20px; text-transform: uppercase;border-radius: 10px; padding: 8px 10px; margin: 0 5px; font-family: utm avo; font-weight: 500; color: #fff; width: 100%;}
    .button_pause35:hover,.button_stop3:hover{background: #0485e9;}     
    ...
    .places{margin-bottom: 0px; font-size: 37px; text-align: center;}
