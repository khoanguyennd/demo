        ...
        <div class="col-4 col-sm-4 col-md-4 pr-10 pl-10">
            <div class="main-bgt">
                ...
                <div class="start_luot_button mt-lg-5">
                    ...
                    <a type="button"  class="start_player_diem_color-bl button_play_mode2 btn btn-primary btn-orange w-100 ml-0 pt-3 pb-3 s-30 mt-3"><?=$this->language("l_play") ?>
                        <?php if ($auto5s == 0) { ?>
                            <span id="timer">(5)</span>
                            <?php Session::set('auto5s', 1); ?>
                        <?php } ?> 
                    </a>
                    <a type="button" style="display: none" class="start_player_diem_color-bl button_pause2_normal btn btn-primary btn-blue-bn  w-100 ml-0 pt-3 pb-3 s-30 mt-3"><?= $this->language("l_pause") ?></a>
