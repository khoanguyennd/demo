...
class ListproductController extends Controller
{
    ...
    public function downloadExcelProductAjax() {
        $result = ['flag'=>false];
        $format['export']['titleName'] = 'aaa'; // $this->_params['titleName'];
        $format['export']['description'] = 'bbb'; // $this->_params['description'];

        $excel = new OfficeExcel();
        $fileName = 't-bridge-product';
        $items = [];//$this->_model->loadProductTypesByLevel();
        $result['link'] = $excel->writeExcelProduct($fileName, $items);
        $result['flag'] = true;
