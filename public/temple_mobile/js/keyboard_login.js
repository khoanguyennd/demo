...
const Keyboard = {
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {                        
                        var aid = $('#aid').val();
                        var apw = $('#apw').val();
                        var achecked = $('#achecked').val();
                        var url = $baseUrl + '/loginkeyboard.html';
                        var url_re=$baseUrl;
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                if(jsonData.status == true){  
                                    ...
                                    $('.form_item_error').html(jsonData.msg);                                    
                                }
                                $.unblockUI(); 
    ...
    _triggerEvent(handlerName,lang) {
