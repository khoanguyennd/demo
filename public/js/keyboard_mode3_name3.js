const Keyboardmode3name3 = {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_mode3name3", "keyboard--hidden_mode3name3");
        this.elements.keysContainer.classList.add("keyboard__keysname3");
        ...
        document.querySelectorAll(".use-keyboard-input-mode3name3").forEach(element => {
        ...
        function someListener(event){
        	...
        	//console.log(element)
        	if(element.classList.contains("use-keyboard-input-mode3name3") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keysname3")){
	        	
        	}else{
                    var keyboard=document.querySelector(".keyboard_mode3name3");
	            keyboard.classList.add("keyboard--hidden_mode3name3");
        	}
        ...
        if(lang=="en"){
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        var settingname1 = $('#name3').val();
                        document.getElementById("settingname3").value = settingname1;
                        $('.name3').html(settingname1);
                        //$('#usernamepoint1').modal('hide');
                        
                        this.eventHandlers.oninput = oninput;
                        this.eventHandlers.onclose = onclose;
                        this.elements.main.classList.add("keyboard--hidden_mode3name3");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_mode3name3");
    },
