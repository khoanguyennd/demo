const Keyboardregisterlistmember = {
    elements: {
        main: null,
        keysContainer: null,
        keys: []
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_register_listmember", "keyboard--hidden_register_listmember");
        ...
        document.querySelectorAll(".use-keyboard-input-register-listmember").forEach(element => {
        ...
        function someListener(event){
            ...
            //console.log(element)
            if(element.classList.contains("use-keyboard-input-register-listmember") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keys")){

            }else{
                var keyboard=document.querySelector(".keyboard_register_listmember");
                keyboard.classList.add("keyboard--hidden_register_listmember");
            }           
        }
    },
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        var url = $baseUrl + '/registerlistmemberkeyboard.html';
                        $.blockUI({
                        ...
                        $.ajax({
                            ...
                            success:function(data){             
                                ...
                                if(jsonData.status == true){
                                    ...
                                    $('.error_insert').html(jsonData.msg);
                        ...
                        this.elements.main.classList.add("keyboard--hidden_register_listmember");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_register_listmember");
    },
...
window.addEventListener("DOMContentLoaded", function () {
    Keyboardregisterlistmember.init();
});
