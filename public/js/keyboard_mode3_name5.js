const Keyboardmode3name5 = {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_mode3name5", "keyboard--hidden_mode3name5");
        this.elements.keysContainer.classList.add("keyboard__keysname5");
        ...
        document.querySelectorAll(".use-keyboard-input-mode3name5").forEach(element => {
        ...
        function someListener(event){
        	...
        	//console.log(element)
        	if(element.classList.contains("use-keyboard-input-mode3name5") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keysname5")){
	        	
        	}else{
                    var keyboard=document.querySelector(".keyboard_mode3name5");
	            keyboard.classList.add("keyboard--hidden_mode3name5");
        	}
        ...
        if(lang=="en"){
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        var settingname1 = $('#name5').val();
                        document.getElementById("settingname5").value = settingname1;
                        $('.name5').html(settingname1);
                        //$('#usernamepoint1').modal('hide');
                        
                        this.eventHandlers.oninput = oninput;
                        this.eventHandlers.onclose = onclose;
                        this.elements.main.classList.add("keyboard--hidden_mode3name1");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_mode3name5");
    },
    ...
    close() {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.add("keyboard--hidden_mode3name5");        
    }
