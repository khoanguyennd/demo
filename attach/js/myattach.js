...
function changeBrowsers(ele,title){
	...
	var AddMoreimage = $(ele)[0].files.length;
	var currentImage = $('#uploadresult input#flagattach').size();
	var totalImage = AddMoreimage + currentImage;
	if(totalImage > 10) {
		$.fn_alert(true, true, notifyUpload);
		return false;
	}
