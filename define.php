...
define('URL_BASE'			, SCHEME . URL_HOST .'/t_bridge');               			// http://example.com/
...
define('DEFAULT_LANG'	, 'KR'); 									// Ngôn ngữ mặc định
define('DEFAULT_CONTROLLER'	, 'dashboard'); 								// Controller mặc định
define('DEFAULT_ACTION'		, 'index');							    // Action mặc định
define('DEFAULT_PREFIX', 'tb_');
define('DEFAULT_LENGTH', 20);										// Số dòng sql lấy ra tối đa
...
define('DB_HOST'	,'mysql:host=localhost');//		define('DB_HOST'	,'mysql:unix_socket=/cloudsql/klkim-project:asia-northeast1:mysql1'); // Đường dẫn host sql  mysql:host=34.64.107.93'
define('DB_USER'	,'root');										// User sql
define('DB_PWD'		,'');											// Password sql
define('DB_NAME'	,'t_bridge');								// Tên database
?>