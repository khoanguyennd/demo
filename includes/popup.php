			...
			<form action="#" method="post">
				...
				<div class="content">
					...
					<div class="form_group clearfix">
						<div class="form_item">
							<div class="inputconfirm">
								<input type="password" name="password" value="" class="input full checkPW" placeholder="<?=$this->language('l_newpassword')?>" autocomplete="off">
					...
					<div class="form_group clearfix">
						<div class="form_item">
							<div class="inputconfirm">
								<input type="password" name="confirmpassword" value="" class="input full confirmPW" placeholder="<?=$this->language('l_confirmpassword')?>" autocomplete="off">
		...
		<div class="absolute channel big">
			<form action="#" method="post">
						...
						<div class="form_group clearfix">
							...
							<div class="form_item col-xs-8 clearfix">
								<div class="col-xs-5">
									...
									<input id="change_files" style="display: none;" name="file" style="visibility:hidden;" type="file"
				...
				<div class="control align-center">
					<input type="submit" class="btn small hover full" name="submit"  value="<?=$this->language('l_Channel34')?>">
				</div>
			</form>
		</div>
			...
			<form action="#" method="post">
				...
				<div class="content">
					<div class="form_group clearfix">
						<div class="form_item">
                                                    <p>
                                                        <span><?=$this->language('l_nameproduct')?> : </span>
                                                        <a class="one" target="_blank" href=""><?=$this->language('l_nameproduct')?></a> ||
                                                        <a class="two" target="_blank" href=""><?=$this->language('l_detailproductchannel')?></a>
                                                    </p>
						</div>
						<div class="form_item">
						...
						<div class="form_item">
							...
							<p class="height1 checkMaxLengthView" style="position: absolute;top: 280px;left: 330px;">0/100 <?= $this->language('l_warnname')?></p>
						</div>
					</div>
				</div>
				<div class="control">
