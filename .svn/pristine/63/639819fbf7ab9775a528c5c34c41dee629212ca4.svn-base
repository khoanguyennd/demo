            ...
            <div class="form_group clearfix frrow">
                ...
                <div class="row rmclass" data-action="viewperson" data-perid="14">
                    ...
                    <div class="form_group clearfix">
                        ...
                        <div class="form_item col-xs-1" style="width: 140px;">
                            <select class="select small full"   id="type1Ids" name="type1Ids" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                        ...
                        <div class="form_item col-xs-1" style="width: 140px;">
                            <select class="select small full changeTypeProduct"  id="type2Ids" name="type2Ids" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                    ...
                    <div class="form_group clearfix">
                        ...
                        <div class="form_item col-xs-1" id="ochannel" style="width: 140px;">
                            <select class="select small full" class="TextBoxField" id="idChannel" onchange="changeChannel(this.value)" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                               	<?php
                                    $i = 0;
                                    foreach ($list_channel as $value => $giatri) {
                                        $i++;
                                ?>
                                    <option value="<?= $giatri["channel_id"] ?>" <?php if($i==1) echo 'selected="selected"';?>  ><?= $giatri["channel_name"] ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form_item col-xs-1" id="otype1" style="width: 140px;">
                            <select class="select small full" class="TextBoxField" onchange="changeType1(this.value)" id="type1Id" name="type1Id" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                            <?php
                                $i = 0;$type_depth1="";
                        ...
                        <div class="form_item col-xs-1" id="otype2" style="width: 140px;">
                            <select class="select small full" class="TextBoxField" onchange="changeType2(this.value)" id="type2Id" name="type2Id" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                            <?php
                                $i = 0;$type_depth2="";
                        ...
                        <div class="form_item col-xs-1" id="otype3" style="width: 140px;">
                            <select class="select small full" class="TextBoxField" onchange="changeType3(this.value)" id="type3Id" name="type3Id" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                            <?php
                                $i = 0;$type_depth3="";
                        ...
                        <div class="form_item col-xs-1" id="otype4" style="width: 140px;">
                            <select class="select small full" class="TextBoxField" id="type4Id" name="type4Id" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                            <?php
                                $i = 0;$type_depth4="";
                ...
                <div class="row rmclass" data-action="viewperson" data-perid="14">
                    ...
                    <div class="form_group clearfix">
                        ...
                        <div class="form_item col-xs-2">
                            <select name="supplier" onchange="flagChanges();" id="supplier" class="select small full" <?php if($noedit==1) echo 'disabled="disabled"';?>>
                                <?php foreach ($list_supplier as $value => $giatri) { ?>
                                <option <?php if ($supplier == $giatri['idx']) echo 'selected="selected"'; ?> 
