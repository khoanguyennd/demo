const Keyboardmode3name1 = {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_mode3name1", "keyboard--hidden_mode3name1");
        this.elements.keysContainer.classList.add("keyboard__keysname1");
        ...
        document.querySelectorAll(".use-keyboard-input-mode3name1").forEach(element => {
        ...
        function someListener(event){
        	...
        	//console.log(element)
        	if(element.classList.contains("use-keyboard-input-mode3name1") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keysname1")){
	        	
        	}else{
                    var keyboard=document.querySelector(".keyboard_mode3name1");
	            keyboard.classList.add("keyboard--hidden_mode3name1");
        	}
        ...
        if(lang=="en"){
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        var settingname1 = $('#name1').val();
                        document.getElementById("settingname1").value = settingname1;
                        $('.name1').html(settingname1);
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_mode3name1");
    },
