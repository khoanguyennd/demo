    ...
    static function createPersonHtml($language, $data){
        ...
        foreach ($data as $key => $value){ 
            ...
            $strhtml .= '<div class="form_group clearfix frrow">
                            <div class="row rmclass'.$hiden2.'"  data-action="'.$action.'" data-perid="'.$value['person_id'].'">
                                <div class="form_group clearfix">
                                    ...
                                    <div class="form_item col-xs-5">
                                        ...
                                        <input type="text" name="aperson" '.$disabled.' value="'.$value['person_name'].'" 
                                ...
                                <div class="form_group clearfix">
                                    ...
                                    <div class="form_item col-xs-5">
                                        <div class="inputconfirm">
                                            <input type="text" name="aphone" '.$disabled.' class="input full checkEmpty" value="'.$value['person_phone'].'"  autocomplete="off" onkeypress="validate()">
                                        </div>
                                    </div>
                                    <div class="form_item col-xs-4"></div>
                                </div>
                                <div class="form_group clearfix">
                                    <div class="form_item col-xs-3">
                            			...
                            			<div class="form_item col-xs-5">
                            				<div class="inputconfirm">
                            					<input type="text" name="aemail" value="'.$value['person_email'].'" '.$disabled.' class="input full checkEmail" autocomplete="off" placeholder="'. $language['l_email']. '">
                            				</div>
                            				<p class="note">'. $language['l_warnemail2']. '</p>
                            				<div class="inputconfirm">
                            					<input type="text" class="input full" name="accode" autocomplete="off" '.$disabled.' placeholder="'. $language['l_codeconfirm']. '">
                            				</div>								
                            			</div>							
                            			<div class="form_item col-xs-4 align-left">								
                            				<input type="button" class="btn hover sendCode '.$hiden2.'"style="width: 100px;" value="'. $language['l_sendcodeconfirm']. '">
                                            <input type="button" class="btn hover changeEmail" hidden="hidden" style="width: 100px;" value="'. $language['l_changeemail']. '">
                            				<p style="color: transparent;padding-top: 5px;">hidden</p>
                            				<input type="button" class="btn hover codeConfirm '.$hiden2.'" style="width: 100px;" value="'. $language['l_confirmcodeconfirm']. '">
                            			</div>	
                            		</div>	
                                <div class="form_group control">
                                    <div class="form_item align-center" style="width: 50%; margin:auto">
                                        <input type="button" name="edit" value="'. $language['l_button_edit_responsible']. '" class="btn hover btnedit '.$hiden1.'" data-perid="'.$value['person_id'].'" style="padding-left:40px;padding-right:40px;">
                                        <input type="button" name="delete" value="'. $language['l_button_delete_responsible']. '" class="btn hover btndelete '.$hiden1.'"  data-perid="'.$value['person_id'].'" data-peremail="'. $value['person_email'] .'" style="padding-left:40px;padding-right:40px;">

                                        <input type="button" name="save" value="'. $language['l_button_save_responsible']. '" class="btn hover btnsave '.$hiden2.'" data-perid="'.$value['person_id'].'" style="padding-left:40px;padding-right:40px;">
                                        <input type="button" name="cancel" value="'. $language['l_button_cancel_responsible']. '" class="btn hover btncancel  hiden" data-perid="'.$value['person_id'].'" data-peremail="'. $value['person_email'] .'" style="padding-left:40px;padding-right:40px;">
                                    </div>
                                </div>			
                        	</div>
                            <div class="icons rmclass'.$hiden2.'"> </div>
                        </div>';
    ...
    static function createRowQuestionmobi($data, $length, $begin){
        ...
        if($data){
            foreach ($data as $key => $value){
                ...
                $manage = "답변등록";//self::$_language['l_anwser'];
                $statusReply = self::$_language['l_anwserbefore'];
                if($value['reply_created']){                    
                    $statusReply = self::$_language['l_anwserdone'];
                    $manage = '답변보기';//self::$_language['l_edit'];
                }
                $begin=$begin+1;
                $strHtml .= '<div class="list_cauhoi">
                            ...
                            <div class="list_cauhoi_2">
                                <input type="button" name="action" value="'.$manage.'" data-qsid="'.$value['question_id'].'" data-channel="'.$value['channel_name'].'" data-dealid="'.$value['dealId'].'" class="btn hover active manager question'.$value['question_id'].'">
