		            ...
		            <div class="row main-bgt" style="padding: 0px">
		                <div class="col-12 bgt-blue p-0">
		                    <div class="title b-line">
		                        <div class="row">
		                            <div class="col">
		                                <h3 class="text-left" style="padding-left: 5px"><?= $this->language("l_total"); ?> <span id="totalUser"><?= $this->getData('totalMember'); ?></span> <?= $this->language("l_people"); ?></h3>
		                            </div>
		                            <div class="col" style="margin-right: 5px; padding-top: 2px; padding-bottom: 2px">
			                ...
			                <div class="main-ct" style="padding: 0px 0px">			                			                
			                	<div class="hide-scroll">
                                	<div class="viewport" style="margin-top: 10px;">
					                	<div class="row rows_list" style="height: 300px;margin-right:18px;margin-left: 2px; padding-right: 0px !important;">
						                    <?php
						                    $listUser = $this->getData('listUser');
						                    foreach ($listUser as $key => $val) {
						                    ?>                        
						                        <div class="col-4 tv_rows" style="padding-left: 2px; padding-right: 2px; margin-bottom:4px" onclick="getPlayer('<?= $val['id']; ?>', '<?= $val['name']; ?>', '<?= $val['diem']; ?>', '<?= $val['avg']; ?>', '<?= $val['highrun']; ?>')">	                               
	...
	<div class="modal-dialog" role="document">
	    <div class="modal-content bgt-blue">
	      <div class="modal-body p-0 b-line">
	    	<div class="title text-center"><h3><?= $this->language("l_pointend") ?></h3></div>
...
<div class="modal fade" id="luotcoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content bgt-blue">
      <div class="modal-body p-0 b-line">
    	<div class="title text-center"><h3><?= $this->language("l_luot") ?></h3></div>
...
<div class="modal fade" id="ThoiGianModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content bgt-blue">
      <div class="modal-body p-0 b-line">
    	<div class="title text-center"><h3><?= $this->language("l_thoigian") ?></h3></div>
		<div class="list-luot-co t-line">
			<ul style="list-style-type: none;" class="m-0">
				...
				<div class="row">
					<div class="col-5">						
						<div id="khaicuocuser_player1" onclick="activekhaicuoc(1)" class="thanh-vien-item box-shadow">							
							<div class="row">
								<div class="col-12">
									<div class="name-thanh-vien text-center w-100 p-0 lh-40 mt-2 player_name_khaicuoc1" style="text-transform: uppercase"></div>
								</div>
								<div class="col-4">
									<div class="circle-big float-none m-0 m-auto"><img src="<?= URL_PUBLIC ?>images/thanh-vien-1.png"></div>
								</div>															
								<div class="col-8 thanh-vien-ct w-100">																		
									<div class="detail_tv mt-2">
										<div class="w-40 float-left text-left">										
										...
										<div class="w-60 float-left text-right" style="font-size: 13px">
					...
					<div class="col-2">
						<div class="text-center" style="padding-top: 20px">
							<img style="max-width: 25px" src="<?= URL_PUBLIC ?>images/vs.png">
						</div>					
					</div>
					<div class="col-5">						
						<div id="khaicuocuser_player2" onclick="activekhaicuoc(2)" class="thanh-vien-item box-shadow">
							<div  class="row">						
								<div class="col-12">
									<div class="name-thanh-vien text-center w-100 p-0 lh-40 mt-2 player_name_khaicuoc2" style="text-transform: uppercase"></div>
								</div>
								<div class="col-4">
									<div class="circle-big float-none m-0 m-auto"><img src="<?= URL_PUBLIC ?>images/thanh-vien-1.png"></div>
								</div>
...
<div class="modal fade" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content bgt-blue">
        <div class="modal-body p-0 b-line">
        <div class="title text-center"><h3><?= $this->language("l_title_notify") ?></h3></div>
...
<style type="text/css">
	@media (min-width: 992px) and (max-width: 1200px){
		...
		#ThoiGianModal .modal-dialog{max-width: 40%; margin-top: 10%}
		#luotcoModal .modal-dialog{max-width: 40%; margin-top: 10%}
		#diem1Modal .modal-dialog{max-width: 50%; margin-top: 10%}
		#diem2Modal .modal-dialog{max-width: 50%; margin-top: 10%}
		#playerModal .modal-dialog{max-width: 80%; margin-top: 5%}
		#khaicuocModal .modal-dialog{max-width: 80%; margin-top: 10%}
		#errorModal .modal-dialog{max-width: 50% !important; margin-top: 20%}

		.main_container_setting_mobi{padding: 0 10px; position: relative;}
		.main_container_setting_mobi .logo{ width:25%; float: left;margin: 6px 0 6px 0;}
		.main_container_setting_mobi .title_mode{ width:25%; float: left; padding-top: 12px}
		.main_container_setting_mobi .title_mode h2{font-weight:bold; font-size: 16px;text-transform:uppercase;}
		.main_container_setting_mobi .main-ct{padding: 5px 5px; border-top: #058cfe 1px solid;display: table; width: 100%;}
		.main_container_setting_mobi .main-bgt{margin : 5px 0px; background-color: rgba(0, 1, 51, 0.3); border: #056cc3 1px solid; border-radius: 10px; padding: 5px;}
		.main_container_setting_mobi .thanh-vien-item{background: linear-gradient(90deg, rgba(1,30,69,1) 0%, rgba(1,45,105,1) 35%, rgba(1,53,124,1) 100%); border: #1e93f6 2px solid; padding: 14px !important; border-radius: 8px; float: left; width: 100%;}		
		.main_container_setting_mobi .thanh-vien-item:hover {border:#cb7309 2px solid !important;}
		.main_container_setting_mobi .name-thanh-vien{width: 100%; text-align:center; font-size: 18px; font-weight: bold; color: #fff;}	
		.khaicuocuser_player_active {border: #cb7309 2px solid;border-radius: 8px;float: left;margin-bottom: 15px ;width: 100%;}

		.main_container_setting_mobi .group-input-left {width: 50%; float: left; padding-right: 8px}
		.main_container_setting_mobi .group-input-right {width: 50%; float: left; padding-left: 8px}
		.main_container_setting_mobi .main-ct .mg-b-32 {margin-bottom:32px !important; }
		.main_container_setting_mobi .main-ct .mg-t-20 { margin-top: 20px !important;}
		.main_container_setting_mobi .main-ct .mg-b-10 { margin-bottom: 10px !important; }
		.main_container_setting_mobi .main-ct .point-end {padding: 10px 10px !important; font-size: 16px !important; border-radius: 6px !important;}	
		.main_container_setting_mobi .btnSetting{ font-size: 12px; padding: 0px 12px; line-height: 30px;}
		.group_btn_setting {margin: 6px 0 6px 0;}

		.menu-top{margin-bottom: 10px; padding-top: 5px;}
		.logo img{width:115px; max-width: 140px}
		.part-choose{width: 30%; float: left}
		.part-info-play{width: 69%; margin-left: 1%; float: left}
		.main-ct p{font-size: 18px}
	}
	...
	@media (max-width: 992px) and (min-width: 768px){
		...
		.main_container_setting_mobi .thanh-vien-item{background: linear-gradient(90deg, rgba(1,30,69,1) 0%, rgba(1,45,105,1) 35%, rgba(1,53,124,1) 100%); border: #1e93f6 2px solid; padding: 14px !important; border-radius: 8px; float: left; width: 100%;}		
		.main_container_setting_mobi .thanh-vien-item:hover {border:#cb7309 2px solid !important;}
		.main_container_setting_mobi .name-thanh-vien{width: 100%; text-align:center; font-size: 18px; font-weight: bold; color: #fff;padding: 0}	
		.khaicuocuser_player_active {border: #cb7309 2px solid;border-radius: 8px;float: left;margin-bottom: 15px ;width: 100%;}
	...
	@media (min-width: 520px) and (max-width: 768px){		
		#ThoiGianModal .modal-dialog{max-width: 70%; margin-top: 10%}
		#luotcoModal .modal-dialog{max-width: 70%; margin-top: 10%}
		#diem1Modal .modal-dialog{max-width: 70%; margin-top: 10%}
		#diem2Modal .modal-dialog{max-width: 70%; margin-top: 10%}
		#playerModal .modal-dialog{max-width: 90%; margin-top: 5%}
		#khaicuocModal .modal-dialog{max-width: 80%; margin-top: 10%}
		#errorModal .modal-dialog{max-width: 50% !important; margin-top: 20%}
		...
		.main_container_setting_mobi .name-thanh-vien{width: 100%; text-align:center; font-size: 18px; font-weight: bold; color: #fff;padding: 0}	
		.main_container_setting_mobi .thanh-vien-item{background: linear-gradient(90deg, rgba(1,30,69,1) 0%, rgba(1,45,105,1) 35%, rgba(1,53,124,1) 100%); border: #1e93f6 2px solid; padding: 11px !important; border-radius: 8px; float: left; width: 100%;}
		.khaicuocuser_player_active {border: #cb7309 2px solid;border-radius: 8px;float: left;margin-bottom: 15px ;width: 100%;}
		...
		.main_container_setting_mobi .main-ct .mg-b-32 {margin-bottom:32px !important; }
		.main_container_setting_mobi .main-ct .mg-t-20 { margin-top: 20px !important;}
		.main_container_setting_mobi .main-ct .mg-b-10 { margin-bottom: 6px !important; }
		.main_container_setting_mobi .main-ct .point-end {padding: 10px 10px !important; font-size: 14px !important; border-radius: 6px !important;}	
		.main_container_setting_mobi .btnSetting{ font-size: 11px; padding: 0px 4px; line-height: 28px;}
		.group_btn_setting {margin: 6px 0 6px 0;}
		...
		.part-choose{width: 30%; float: left}
		.part-info-play{width: 69%; margin-left: 1%; float: left}
		.main-ct p{font-size: 16px}
	}

	@media (min-width: 350px) and (max-width: 520px){
		#ThoiGianModal .modal-dialog{max-width: 75%; margin-top: 10%}
		#luotcoModal .modal-dialog{max-width: 75%; margin-top: 10%}
		#diem1Modal .modal-dialog{max-width: 75%; margin-top: 10%}
		#diem2Modal .modal-dialog{max-width: 75%; margin-top: 10%}
		#playerModal .modal-dialog{max-width: 85%; margin-top: 5%}
		#khaicuocModal .modal-dialog{max-width: 90%; margin-top: 10%}
		#errorModal .modal-dialog{max-width: 50% !important; margin-top: 20%}

    	.main_container_setting_mobi{padding: 0 10px; position: relative;}
		.main_container_setting_mobi .logo{ width:25%; float: left;margin: 6px 0 6px 0;}
		.main_container_setting_mobi .title_mode{ width:25%; float: left; padding-top: 12px}
		.main_container_setting_mobi .title_mode h2{font-weight:bold; font-size: 13px;text-transform:uppercase;}
		.main_container_setting_mobi .main-ct{padding: 5px 5px; border-top: #058cfe 1px solid;display: table; width: 100%;}
		.main_container_setting_mobi .main-bgt{margin : 0px 0px; background-color: rgba(0, 1, 51, 0.3); border: #056cc3 1px solid; border-radius: 10px; padding: 5px;}
		...
		.main_container_setting_mobi .name-thanh-vien {font-size: 15px !important; line-height: 22px !important;padding: 0}
		.khaicuocuser_player_active {border: #cb7309 2px solid;border-radius: 8px;float: left;margin-bottom: 15px ;width: 100%;}
		...
		.main_container_setting_mobi .main-ct .mg-t-20 { margin-top: 20px !important;}
		.main_container_setting_mobi .main-ct .mg-b-10 { margin-bottom: 6px !important; }
		.main_container_setting_mobi .main-ct .point-end {padding: 2px 2px !important; font-size: 13px !important; border-radius: 6px !important;}	
		.main_container_setting_mobi .btnSetting{ font-size: 10px; padding: 0px 0px; line-height: 22px;}
		.group_btn_setting {margin: 6px 0 6px 0;}

		.title h3 {font-size: 12px; font-weight: bold;margin-top: 15px;}

		.menu-top{ margin-bottom: 10px;padding-top: 5px;}
		.logo img{width:115px; max-width: 140px}
		.part-choose{width: 30%; float: left}
		.part-info-play{width: 69%; margin-left: 1%; float: left}
		.main-ct p{font-size: 14px}
	}
</style>
<div class="container-fluid main_container_setting_mobi">
	<div class="menu-top">
		<div class="logo">
			<img src="<?= URL_PUBLIC ?>images/logo-1.png" class="img-fluid" alt="Billiard">
		</div>
		<div class="text-right title_mode">			
			<h2><?= $this->language("l_mode2") ?></h2>			
		</div>			
		<div class="text-right" style="width: 50%; float: left">
			<div class="group_btn_setting">
				<a type="button" onclick="closeWin()" class="btn btn-primary btn-blue shadow_button btnSetting"><?= $this->language("l_closemode") ?></a>
				<a type="button" class="button_confirm btn-orange-sm btnSetting"><?= $this->language("l_start") ?></a>		
			</div>			
		</div>
		<div style="clear: both"></div>
	</div>					
	<div class="main-bgt">
		<div class="bgt-blue part-choose">
			<div class="title b-line text-center"><h3><?= $this->language("l_selectplayer") ?></h3></div>
			<div class="main-ct">					
				<div class="username">
		...
		<div class="bgt-blue p-0 part-info-play">
			<div class="bgt-blue">
				<div class="title b-line text-center"><h3><?= $this->language("l_setting_point") ?></h3></div>
				<div class="main-ct">
					<div class="mg-b-32 mg-t-20 pr-10 pl-10">
                ...
                if(jsonData.status == true){                                    
                    ...
                    $.each(listUser,function(i,item){                                        
               			if(jsonData.mobile != 0){	
               				itemUser = '<div class="col-4 tv_rows" style="padding-left: 2px; padding-right: 2px; margin-bottom:4px" onclick="getPlayer('+"'" + item.id +"'"+', ' +"'" + item.name +"'" +', ' +"'" + item.diem +"'" +', ' +"'" + item.avg +"'" +', ' +"'" + item.highrun +"'" +')">';
