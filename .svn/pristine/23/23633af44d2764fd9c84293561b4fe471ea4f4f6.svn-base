...
JsDatePick.prototype.populateFieldWithSelectedDate=function(){
		...
		$("#"+this.oConfiguration.target).val(this.getSelectedDayFormatted()).trigger('change');
		if(this.lastPickedDateObject){
			delete (this.lastPickedDateObject)}this.lastPickedDateObject={};
			...
			this.closeCalendar()};JsDatePick.prototype.makeCalendar=function(){
				var j=document,e,a,b,k,g,h,f,o,i,m,n,l,c;
				e=j.createElement("div");
				a=j.createElement("div");b=j.createElement("div");
				...
				this.JsDatePickBox=e;
						...
						if(this.isie&&this.iever==6){
							f.style.bottom="-2px"}o=j.createElement("div");
							...
							e.appendChild(a);
							if(!this.oConfiguration.isStripped){
								e.appendChild(b);e.appendChild(h);
								e.appendChild(f)
							}
							if(this.oConfiguration.useMode==2){
								if(this.oConfiguration.target!=false){
									if(typeof(JsgetElem(this.oConfiguration.target))!=null){
										...
										e.style.position="absolute";e.style.top="18px";
										e.style.left="0px";
							...
							JsDatePick.prototype.isAvailable=function(c,a,b){
								...
								if(b>this.oCurrentDay.day&&a==this.oCurrentDay.month&&c==this.oCurrentDay.year){return false}
								return true
							};
							JsDatePick.prototype.getDOMCalendarStripped=function(){
								...
								this.boxMain=e;i=h.createElement("div");
								...
								this.tooltip=f;e.appendChild(i);
								...
								JsDatePick.prototype.setSelectedDay=function(a){
									...
									JsDatePick.prototype.isSelectedDay=function(a){
										if(this.flag_aDayWasSelected){
											if(parseInt(a)==this.selectedDayObject.day&&this.currentMonth==this.selectedDayObject.month&&this.currentYear==this.selectedDayObject.year){return true}else{return false}
										}
										return false};
										...
										JsDatePick.prototype.isToday=function(a){
											...
											if(a.getDate()==this.oCurrentDay.day&&a.getMonth()==b&&a.getFullYear()==this.oCurrentDay.year){return true}
											return false
										};
										JsDatePick.prototype.setControlBarText=function(a){
											...
											JsDatePick.prototype.setTooltipText=function(a){
												...
												JsDatePick.prototype.moveForwardOneMonth=function(){
													if(this.currentMonth<12){this.currentMonth++}else{
														if(this.moveForwardOneYear()){
															this.currentMonth=1
														}else{this.currentMonth=12}
													}
													this.repopulateMainBox()};
													JsDatePick.prototype.moveBackOneMonth=function(){
														if(this.currentMonth>1){this.currentMonth--}else{
														...
														JsDatePick.prototype.getDOMControlBar=function(){
															...
															f=h.createElement("div");g=h.createElement("div");
															b=h.createElement("div");a=h.createElement("div");
															e=h.createElement("div");this.setC(c,"controlsBar");
															...
															f.onmouseover=function(){
																...
																if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){return}
																d=this.parentNode;
																while(d.className!="controlsBar"){d=d.parentNode}
																...
																if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){return}
																i=this.parentNode;
																while(i.className!="controlsBar"){i=i.parentNode}
