...
<div class="main_history containerHistory<?=$thanhvien1['id']?>">
    ...
    <div class="row b-line-d m-0 pb-14 rows_history rowshow<?=$thanhvien1['id']?>">        
        ...
        <div class="col-md-4 pt-2"><p class="mb-1 rowshowPoint<?=$thanhvien1['id']?>">0</p></div>
        <div class="col-md-4 pt-2"><p class="mb-1 rowshowTime<?=$thanhvien1['id']?>">0</p></div>        
    </div>
    <?php endif; ?>
