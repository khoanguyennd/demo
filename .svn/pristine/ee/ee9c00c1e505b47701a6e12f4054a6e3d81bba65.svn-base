                    ...
                    <div class="form_group clearfix">
                        ...
                        <div class="form_item col-xs-2">
                            ...
                            <select name="supplier" onchange="flagChanges();" id="supplier" class="select small full">
                                <option <?php if ($supplier == $account['idx']) echo 'selected="selected"'; elseif($noedit==1) echo 'disabled="disabled"';?> value="<?= $account['idx'] ?>"><?= $account['ID'] ?></option>
                                <?php foreach ($list_supplier as $value => $giatri) { ?>
                                <option <?php if ($supplier == $giatri['idx']) echo 'selected="selected"'; elseif($noedit==1) echo 'disabled="disabled"';?> value="<?= $giatri['idx'] ?>"><?= $giatri['ID'] ?></option>
                                <?php } ?>
