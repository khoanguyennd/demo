...
<style type="text/css">
    ...
    @media (min-width: 520px) and (max-width: 768px){
        ...
        .start_mobi_container .item_col_player{width: 35%;}
        .start_mobi_container .item_col_main{width: 30%;padding-right:4px; padding-left: 4px}
        .start_mobi_container  button.btn-blue-n{padding: 6px 16px !important} 
        .start_mobi_container .start_player_diem {
            border-radius: 50%;
            text-align: center;
            font-size: 90px;
        ...
        .start_mobi_container span.start_player_diem_span1 {
            position: absolute;
            top: 0px;
            left: 0px;
            font-size: 11px;
        ...
        .start_mobi_container span.start_player_diem_span2 {
            position: absolute;
            top: 0px;
            right: 0px;
            font-size: 11px;
        ...
        #conformStop .list-diem-a p {font-size: 8px !important;}
    ...
    @media (min-width: 350px) and (max-width: 520px){
        ...
        .start_mobi_container .item_col_player{width: 35%;}
        .start_mobi_container .item_col_main{width: 30%;padding-right:4px; padding-left: 4px}
        .start_mobi_container  button.btn-blue-n{padding: 4px 16px !important; font-size: 8px !important;} 
        .start_mobi_container .start_player_diem {
            border-radius: 50%;
            text-align: center;
            font-size: 40px;
...
<div class="container-fluid start_mobi_container">
