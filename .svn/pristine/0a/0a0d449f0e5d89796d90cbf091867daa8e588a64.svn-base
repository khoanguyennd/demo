...
<div class="main_history_mobi containerHistory<?=$thanhvien2['id']?>">
    ...
    <div class="row b-line-d m-0 pb-14 rows_history rowshow<?=$thanhvien2['id']?>">        
        ...
        <div class="col-4 pt-2"><p class="mb-1 rowshowPoint<?=$thanhvien2['id']?>">0</p></div>
        <div class="col-4 pt-2"><p class="mb-1 rowshowTime<?=$thanhvien2['id']?>">0</p></div>        
    </div>
    <?php endif; ?>
    <?php
    $stt = 1; 
