const Keyboardsearchusersetting = {
    elements: {
        main: null,
        keysContainer: null,
        keys: []
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_search_user_setting", "keyboard--hidden_search_user_setting");
        ...
        // Automatically use keyboard for elements with .use-keyboard-input-search-user-setting
        document.querySelectorAll(".use-keyboard-input-search-user-setting").forEach(element => {
        ...
        function someListener(event){
            ...
            //console.log(element)
            if(element.classList.contains("use-keyboard-input-search-user-setting") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keys")){

            }else{
                var keyboard=document.querySelector(".keyboard_search_user_setting");
                keyboard.classList.add("keyboard--hidden_search_user_setting");
            }           
        }
    },
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                            ...
                            success:function(data){         
                                ...
                                if(jsonData.status == true){
                                    ...
                                    $.each(listUser,function(i,item){
                                        if(item.id==settingplayer1||item.id==settingplayer2){
                                            total++;
                                        }else{
                                    ...
                                    var showtotal=jsonData.total-total;
                                    $('#totalUser').html(showtotal); 
                        ...
                        this.elements.main.classList.add("keyboard--hidden_search_user_setting");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_search_user_setting");
    },
...
window.addEventListener("DOMContentLoaded", function () {
    Keyboardsearchusersetting.init();
});
