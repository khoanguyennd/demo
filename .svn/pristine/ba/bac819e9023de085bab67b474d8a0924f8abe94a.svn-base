...
<div class="container-fluid">
    ...
    <div class="row mt-3">
        <div id="start_player1" class="col-md-4 pr-10">
            <div class="bgt-blue mb-3">
                <div class="star-player-top b-line pt-4 pb-3 pl-4">
                    <div class="row">
                        <div class="w-65 pr-0 pl-3">
                            <h3 class="name-item"><?=$thanhvien1['name']?></h3>
                        </div>
                        <div class="w-35 pl-0" data-toggle="modal" data-target="#chitietthanhvien">
                ...
                <div class="star-player-main t-line b-line pt-5">
                    ...
                    <div class="start_player_button m-auto m-0 pt-4">
                        <button class="button_minus btn btn-primary btn-blue-n button2point<?=$thanhvien1['id']?>" style="margin-right: 10px" data-id="<?=$thanhvien1['id']?>" >
                ...
                <div class="start_player_thongke t-line">
                    <div class="row">
                        <div class="col-md-3 r-line pt-2">
                            <p class="color-or s-30 mb-1" id="avg<?=$thanhvien1['id']?>"><?=$statisticalUser[1]['avg']?></p>
                            <p>AVG</p>
                        </div>
                        <div class="col-md-3 r-line l-line pt-2">
                            <p class="color-or s-30 mb-1" id="hight<?=$thanhvien1['id']?>"><?=$statisticalUser[1]['hight']?></p>
                            <p><?=$this->language("l_high")?></p>
                        </div>
                        <div class="col-md-3 r-line l-line pt-2">
                            <p class="color-or s-30 mb-1" id="sobicham<?=$thanhvien1['id']?>"><?=$statisticalUser[1]['number_balltouches']?></p>
                            <p><?=$this->language("l_numbercham")?></p>
                        </div>
                        <div class="col-md-3 l-line pt-2">
                            <p class="color-or s-30 mb-1"><span id="time<?=$thanhvien1['id']?>"><?=$statisticalUser[1]['total_time']?></span><span style="text-transform: none;">s</span></p>
        ...
        <div class="col-md-4 pr-10 pl-10">
            <div class="main-bgt">
                ...
                <div class="start_luot_button mt-5">
                    ...
                    <button type="button" class="resettime btn btn-primary btn-orange w-100 ml-0 pt-3 pb-3 s-30 mb-1 ml-0"><?=$this->language("l_button_resettime_model2")?></button>
        ...
        <!---------------------------end center--------------------------->
        <div id="start_player2" class="col-md-4 pl-10">
            <div class="bgt-blue mb-3">
                <div class="star-player-top b-line pt-4 pb-3 pl-4">
                    <div class="row">
                        <div class="w-65 pr-0 pl-3">
                        ...
                        <div class="w-35 pl-0" data-toggle="modal" data-target="#chitietthanhvien2">
                            <div class="diem-chap-tv">
                ...
                <div class="star-player-main t-line b-line pt-5">
                    ...
                    <div class="start_player_button m-auto m-0 pt-4">                        
                        <button class="button_minus btn btn-primary btn-blue-n button2point<?=$thanhvien2['id']?>" style="margin-right: 10px" data-id="<?=$thanhvien2['id']?>">
                            <i class="fa fa-minus" aria-hidden="true"></i>
                        </button>
                ...
                <div class="start_player_thongke t-line ">
                    <div class="row">
                        <div class="col-md-3 r-line pt-2">
                            <p class="color-or s-30 mb-1" id="avg<?=$thanhvien2['id']?>"><?=$statisticalUser[2]['avg']?></p>
                            <p>AVG</p>
                        </div>
                        <div class="col-md-3 r-line l-line pt-2">
                            <p class="color-or s-30 mb-1" id="hight<?=$thanhvien2['id']?>"><?=$statisticalUser[2]['hight']?></p>
                            <p><?=$this->language("l_high")?></p>
                        </div>
                        <div class="col-md-3 r-line l-line pt-2">
                            <p class="color-or s-30 mb-1" id="sobicham<?=$thanhvien2['id']?>"><?=$statisticalUser[2]['number_balltouches']?></p>
                            <p><?=$this->language("l_numbercham")?></p>
                        </div>
                        <div class="col-md-3 l-line pt-2">
                            <p class="color-or s-30 mb-1"><span id="time<?=$thanhvien2['id']?>"><?=$statisticalUser[2]['total_time']?></span><span style="text-transform: none;">s</span></p>
                            <p><?=$this->language("l_shot")?></p>
                        </div>
                    </div>
                </div>  
            ...
            success:function(data){             
                ...
                if(jsonData.status == true){
                    ...
                    str = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rowUser' + hidden +'">';                       
                       str += '<div class="col-md-4 pt-2"><p class="mb-1">' + jsonData.inning + '</p></div>';
                       str += '<div class="col-md-4 pt-2"><p class="mb-1">' + jsonData.score + '</p></div>';
                       str += '<div class="col-md-4 pt-2"><p class="mb-1">' + jsonData.shot + '</p></div>';                       
                    str +='</div>';
                    ...
                    if(currentluotco < parseInt(jsonData.luotco)){
                        ...
                        strshowuser1 = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rowshow' + hidden +'">';                           
                           strshowuser1 += '<div class="col-md-4 pt-2"><p>' + jsonData.luotco + '</p></div>';
                           strshowuser1 += '<div class="col-md-4 pt-2"><p class="mb-1 rowshowPoint' + hidden + '">0</p></div>';
                           strshowuser1 += '<div class="col-md-4 pt-2"><p class="mb-1 rowshowTime' + hidden + '">0</p></div>';                           
                        strshowuser1 +='</div>';
                        ...
                        strshowuser2 = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rowshow' + currentUser +'">';                           
                           strshowuser2 += '<div class="col-md-4 pt-2"><p>' + jsonData.luotco + '</p></div>';
                           strshowuser2 += '<div class="col-md-4 pt-2"><p class="mb-1 rowshowPoint' + currentUser + '">0</p></div>';
                           strshowuser2 += '<div class="col-md-4 pt-2"><p class="mb-1 rowshowTime' + currentUser + '">0</p></div>';                           
                        strshowuser2 +='</div>';
            ...
            success:function(data){             
                ...
                if(jsonData.status == true){
                    ...
                    str = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rows_history_cancel rowUser' + hidden +'">';                
                       str += '<div class="col-md-4 pt-2"><p>' + jsonData.inning + '</p></div>';
                       str += '<div class="col-md-4 pt-2"><p>' + jsonData.score + '</p></div>';
                       str += '<div class="col-md-4 pt-2"><p>' + jsonData.shot + '</p></div>';                       
                    str +='</div>';
                    $(str).insertBefore('.rowshow' + hidden);
                    $('.rowshow' + hidden).remove();
                    ...
                    if(currentluotco < parseInt(jsonData.luotco)){
                        ...
                        strshowuser1 = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rowshow' + hidden +'">';                           
                           strshowuser1 += '<div class="col-md-4 pt-2"><p>' + jsonData.luotco + '</p></div>';
                           strshowuser1 += '<div class="col-md-4 pt-2"><p class="rowshowPoint' + hidden + '">0</p></div>';
                           strshowuser1 += '<div class="col-md-4 pt-2"><p class="rowshowTime' + hidden + '">0</p></div>';                           
                        strshowuser1 +='</div>';
                        $(strshowuser1).insertBefore('.rowUser' + hidden);                                                                 

                        strshowuser2 = '<div class="row b-line-d t-line-d m-0 pb-14 rows_history rowshow' + currentUser +'">';                           
                           strshowuser2 += '<div class="col-md-4 pt-2"><p>' + jsonData.luotco + '</p></div>';
                           strshowuser2 += '<div class="col-md-4 pt-2"><p class="rowshowPoint' + currentUser + '">0</p></div>';
                           strshowuser2 += '<div class="col-md-4 pt-2"><p class="rowshowTime' + currentUser + '">0</p></div>';                           
                        strshowuser2 +='</div>';
                        $(strshowuser2).insertBefore('.rowUser' + currentUser); 
                    } 
                    if(parseInt(jsonData.the_end)==1){
