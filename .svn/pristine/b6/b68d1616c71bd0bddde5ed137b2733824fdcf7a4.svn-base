...
<div class="container-fluid bgt-mode">
    <div class="row">
        <div class="col-5 col-sm-4 col-md-4 logo">
            <img src="<?= URL_PUBLIC ?>images/logo-1.png" alt="Billiard" class="img-responsive">
        </div>
        <div class="col-7 col-sm-8 col-md-8 col-xl-4 text-center">
    ...
    <div class="row">
        <div class="container-xl pt-lg-2 pb-lg-5" id = "topM2">
                    ...
                    <div class="main-ct list-luot-co b-line">
                        <div class="row">
                            <!-- <div class="chon_nkc m-0 m-auto"> -->
                                <div class="chon_nkc col-sm-6 col-md-6 mt-4 mb-4">
                                    <a type="button" class="w-100" onclick="showpopupuser(1)">
                                    <div class="thanh-vien-item box-shadow">
                                        <div class="w-100 text-center mt-3">
                                            <div class="circle-big"><img src="<?= URL_PUBLIC ?>images/thanh-vien-2.png"></div>
                                        </div>
