const Keyboardsearchuserlistmember = {
    elements: {
        main: null,
        keysContainer: null,
        keys: []
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_search_user_listmember", "keyboard--hidden_search_user_listmember");
        this.elements.keysContainer.classList.add("keyboard__keyssearch");
        ...
        // Automatically use keyboard for elements with .use-keyboard-input-search-user-listmember
        document.querySelectorAll(".use-keyboard-input-search-user-listmember").forEach(element => {
        ...
        function someListener(event){
            ...
            //console.log(element)
            if(element.classList.contains("use-keyboard-input-search-user-listmember") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keyssearch")){

            }else{
                var keyboard=document.querySelector(".keyboard_search_user_listmember");
                keyboard.classList.add("keyboard--hidden_search_user_listmember");
            }           
        }
    },
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        this.elements.main.classList.add("keyboard--hidden_search_user_listmember");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_search_user_listmember");
    },
...
window.addEventListener("DOMContentLoaded", function () {
    Keyboardsearchuserlistmember.init();
});
