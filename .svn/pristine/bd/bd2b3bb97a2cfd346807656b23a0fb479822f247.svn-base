<style>
    ...
    .text-cus{min-width: 90px;}
    .text-cus-hg{min-width: 90px;}
    .head{ margin-left: 1%;margin-right: 1%;}  
    .viewport{height: 250px !important; margin-top: 5px!important;}
    ...
    @media (min-width: 665px) and (max-width: 820px){
        .head{ margin-left: 1%;margin-right: 1%;padding-bottom: 7px}   
        .viewport{height: 230px !important;}
        .error{
            font-size: 12px !important;
        }
    }
    @media (min-width: 570px) and (max-width: 665px){
        .head{ margin-left: 1%;margin-right: 1%;padding-bottom: 5px}   
        .viewport{height: 210px !important;}
        .from-c {
            font-size: 12px !important;
        }
        .error{
    ...
    @media (min-width: 520px) and (max-width: 570px){
        .head{ margin-left: 1%;margin-right: 1%;padding-bottom: 2px}   
        .viewport{height: 170px !important;}
        .from-c {
            font-size: 12px!important;
        }
    }
...
<div class="head">
    <div class="row">
    	<div style="width: 20%;padding: 10px 0px 0px 15px;"> 
        <img class="logo" src="<?= URL_PUBLIC ?>images/logo-1.png" alt="Billiard">
        </div>
        <div style="width: 36%;padding-top: 20px;">       
         	<h2 class="title_header"><?=$this->language("l_listmember")?></h2>
        </div>

        <div class="float-right text-right mg-b-10" style="width: 40%;padding-top: 10px;">
            ...
            <div class="row main-bgt" style="padding: 10px;">
                <div class="col-12 bgt-blue p-0">
                    <div class="title" style="padding-top: 5px; padding-bottom: 5px;">
                        <div class="row">
                            <div class="col-6">
                                <h3 class="head-h3"><?=$this->language("m_total_member")?>: <span id="totalUser"><?= $this->getData('totalMember'); ?></span></h3>
                            </div>
                                        							
                            <div class="col-6 p-1">       
                                <div class="input-group">
                                    <input type="text" class="form-control ds-input use-keyboard-input-search-user-listmember" style="height: 33px;" id="search-input" placeholder="<?=$this->language("l_search_text_placeholder")?>">
                                    <div class="input-group-append">                                        
                                        <button class="btn btn-primary" id="seachMember" type="button" style="height: 33px;"><i class="fa fa-search" style="font-size: 20px;"></i></button>
                                    </div>
                                </div>                                                                                            
                            </div>
                      </div>
                        <div class="hide-scroll t-line-d">
            ...
            success:function(data){             
                ...
                if(jsonData.status == true){                                    
                    ...
                    $.each(listUser,function(i,item){                                        
                        ...
                        itemUser = '<div class="col-3 tv_rows">';
                                itemUser += '<div class="thanh-vien-item">';
                                    itemUser += '<div class="thanh-vien-ct">';        
                                    itemUser += '<div class="name-thanh-vien color-w text-center w-100 p-0 mg-b-10 lh-40">' + item.name +'</div>';
                             
                                    itemUser += '<div class="row mg-b-10">';
                                        ...
                                        itemUser += '<div class="col-6">';
                                            itemUser += '<div class="text-cus font-10">';
                                                itemUser += '<?=$this->language("l_avg")?>: <span class="color-or">' + item.avg +'</span>';
                                            itemUser += '</div>';
                                            itemUser += '<div class="text-cus-hg font-10">';
                                                itemUser += '<?=$this->language("l_detail_high")?>: <span class="color-or">' + item.highrun + '</span>';
                                            itemUser += '</div>';
                                        itemUser += '</div>';
                                        itemUser += '<div class="col-3">';
    ...
    <div class="modal-dialog" role="document" style="margin-top: 10%">
        <div class="modal-content bgt-blue">
            <div class="modal-body p-0 b-line">
                <div class="title text-center  b-line"><h3><?= $this->language("l_info_member") ?></h3></div>
                <form class="cmxform" id="editFormlistmember" method="get" action="">
                    <div class="list-luot-co t-line">
                        <div class="row">
                            <div class=" m-auto m-0 pl-5 pr-5">
                                <div class="form-row" style="margin-left: -13px; margin-right: -13px">
                                    <input type="hidden" id="memberId" name="memberId">                            
                                    <div class="form-group col-md-12">
                                        <label for="recipient-name" class="col-form-label"><?= $this->language("l_hoten") ?> <span class="required"></span></label>
                                        <input style="margin-bottom: 10px" type="text" disabled="disabled" class="form-control from-c" autocomplete="off" id="infoUserNamelistmember" name="name" placeholder="<?= $this->language("l_hoten_placeholder") ?>">
                                    </div>
                                    <div class="row wid-104">
                                         <div class="form-group col-6">
                                            <label class="col-form-label" for="#"><?= $this->language("l_phone") ?> <span class="required"></span></label>
                                            <input type="text" disabled="disabled" class="form-control from-c" autocomplete="off" id="infoPhonelistmember" name="phone" placeholder="<?= $this->language("l_phone_placeholder") ?>">
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="recipient-name" class="col-form-label"><?= $this->language("l_point") ?><span class="required"></span></label>
                                            <input type="text" disabled="disabled" class="form-control from-c" maxlength="3" autocomplete="off" id="infoPointlistmember" name="point" placeholder="<?= $this->language("l_point_placeholder")?>">
                                        </div>
                                    </div>
...
<div class="modal fade" id="suatvModal_ds" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="margin-top: 10%">
        <div class="modal-content bgt-blue">
            <div class="modal-body p-0 b-line">
                <div class="title text-center  b-line"><h3><?= $this->language("l_edit_member") ?></h3></div>
                <form class="cmxform" id="editFormlistmember" method="get" action="">
                    <div class="list-luot-co t-line">
                        <div class="row">
                            <div class=" m-auto m-0 pl-5 pr-5" style="width: 90%">
                                <div class="form-row">
                                    <input type="hidden" id="memberId" name="memberId">
                                    <div id="msg_err_edit_member" class="error_insert"></div>
                                    <div class="form-group col-md-12">
                                        <label for="recipient-name" class="col-form-label"><?= $this->language("l_hoten") ?> <span class="required"></span></label>
                                        <input style="margin-bottom: 10px" type="text" class="form-control from-c" autocomplete="off" id="editUserNamelistmember" name="name" placeholder="<?= $this->language("l_hoten_placeholder") ?>">
                                    </div>
                                    <div class="row wid-104">
                                        <div class="form-group col-6">
