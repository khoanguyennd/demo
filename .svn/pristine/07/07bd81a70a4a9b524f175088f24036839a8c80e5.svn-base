const Keyboardregister = {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_register", "keyboard--hidden_register");
        ...
        document.querySelectorAll(".use-keyboard-input-register").forEach(element => {
        ...
        function someListener(event){
        	...
        	//console.log(element)
        	if(element.classList.contains("use-keyboard-input-register") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keys")){
	        	
        	}else{
        		var keyboard=document.querySelector(".keyboard_register");
	            keyboard.classList.add("keyboard--hidden_register");
        	}
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        this.elements.main.classList.add("keyboard--hidden_register");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_register");
