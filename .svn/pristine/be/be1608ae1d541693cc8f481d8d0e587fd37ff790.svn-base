const Keyboardmode3name4 = {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard_mode3name4", "keyboard--hidden_mode3name4");
        this.elements.keysContainer.classList.add("keyboard__keysname4");
        ...
        document.querySelectorAll(".use-keyboard-input-mode3name4").forEach(element => {
        ...
        function someListener(event){
        	...
        	//console.log(element)
        	if(element.classList.contains("use-keyboard-input-mode3name4") || element.classList.contains("material-icons") || element.classList.contains("keyboard__key") || element.classList.contains("keyboard__keysname4")){
	        	
        	}else{
                    var keyboard=document.querySelector(".keyboard_mode3name4");
	            keyboard.classList.add("keyboard--hidden_mode3name4");
        	}
        ...
        if(lang=="en"){
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        var settingname1 = $('#name4').val();
                        document.getElementById("settingname4").value = settingname1;
                        $('.name4').html(settingname1);
                        //$('#usernamepoint1').modal('hide');
                        
                        this.eventHandlers.oninput = oninput;
                        this.eventHandlers.onclose = onclose;
                        this.elements.main.classList.add("keyboard--hidden_mode3name4");
    ...
    open(initialValue, oninput, onclose) {
        ...
        this.eventHandlers.oninput = oninput;
        this.eventHandlers.onclose = onclose;
        this.elements.main.classList.remove("keyboard--hidden_mode3name4");
    },
