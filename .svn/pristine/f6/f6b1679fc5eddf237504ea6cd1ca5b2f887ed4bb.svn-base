...
//                     $sheetActive->mergeCells('A2:'.$colAZ[count($columnsNew)-1].'2');
                            ...
                            if(isset($params['insert']) && $params['insert']){
                                foreach ($params['insert'] as $k => $v){
                                    if($col['key'] == $k){
                                        ...
                                        $objValidation = $sheetActive->getCell($colAZ[$j] . $row)
                                        ->getDataValidation();
                                        ...
                                        $option = '"' . implode(",",$v) . '"';
                                        $objValidation->setFormula1($option);
    ...
    public function writeExcelProduct($fileName, $items) {
        require_once PATH_PLUGINS.'PHPExcel/PHPExcel.php';
        $objPHPExcel = new PHPExcel();
        $sheetType = 0;
        ...
        $flag = true;
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('B')->setWidth(5);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('C')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('D')->setWidth(20);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('E')->setWidth(20);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('F')->setWidth(25);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('G')->setWidth(8);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('H')->setWidth(8);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('I')->setWidth(13);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('J')->setWidth(13);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('K')->setWidth(17);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('L')->setWidth(17);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('M')->setWidth(17);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('N')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('O')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('P')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('Q')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('R')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('S')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('T')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('U')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('V')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('W')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('X')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('Y')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('Z')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AA')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AB')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AC')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AD')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AE')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AF')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AG')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AH')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AI')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AJ')->setWidth(15);
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('AK')->setWidth(15);
        ...
        $objPHPExcel->setActiveSheetIndex($sheetType)
            ->setCellValue('B2' , self::$_language['l_listproduct56'])
            ->setCellValue('B' . $i, 'NO')
            ->setCellValue('C' . $i, self::$_language['l_listproduct21'])
            ->setCellValue('D' . $i, self::$_language['l_listproduct22'])
            ->setCellValue('E' . $i, self::$_language['l_listproduct23'])
            ->setCellValue('F' . $i, self::$_language['l_listproduct24'])
            ->setCellValue('G' . $i, self::$_language['l_listproduct25'])
            ->setCellValue('H' . $i, self::$_language['l_listproduct26'])
            ->setCellValue('I' . $i, self::$_language['l_listproduct27'])
            ->setCellValue('J' . $i, self::$_language['l_listproduct28'])
            ->setCellValue('K' . $i, self::$_language['l_listproduct29'])
            ->setCellValue('L' . $i, self::$_language['l_listproduct30'])
            ->setCellValue('M' . $i, self::$_language['l_listproduct31'])
            ->setCellValue('N' . $i, self::$_language['l_listproduct32'])
            ->setCellValue('O' . $i, self::$_language['l_listproduct33'])
            ->setCellValue('P' . $i, self::$_language['l_listproduct34'])
            ->setCellValue('Q' . $i, self::$_language['l_listproduct35'])
            ->setCellValue('R' . $i, self::$_language['l_listproduct36'])
            ->setCellValue('S' . $i, self::$_language['l_listproduct37'])
            ->setCellValue('T' . $i, self::$_language['l_listproduct38'])
            ->setCellValue('U' . $i, self::$_language['l_listproduct39'])
            ->setCellValue('V' . $i, self::$_language['l_listproduct40'])
            ->setCellValue('W' . $i, self::$_language['l_listproduct41'])
            ->setCellValue('X' . $i, self::$_language['l_listproduct42'])
            ->setCellValue('Y' . $i, self::$_language['l_listproduct43'])
            ->setCellValue('Z' . $i, self::$_language['l_listproduct44'])
            ->setCellValue('AA' . $i, self::$_language['l_listproduct45'])
            ->setCellValue('AB' . $i, self::$_language['l_listproduct46'])
            ->setCellValue('AC' . $i, self::$_language['l_listproduct47'])
            ->setCellValue('AD' . $i, self::$_language['l_listproduct48'])
            ->setCellValue('AE' . $i, self::$_language['l_listproduct49'])
            ->setCellValue('AF' . $i, self::$_language['l_listproduct50'])
            ->setCellValue('AG' . $i, self::$_language['l_listproduct51'])
            ->setCellValue('AH' . $i, self::$_language['l_listproduct52'])
            ->setCellValue('AI' . $i, self::$_language['l_listproduct53'])
            ->setCellValue('AJ' . $i, self::$_language['l_listproduct54'])
            ->setCellValue('AK' . $i, self::$_language['l_listproduct55']);

        $sheetActive->mergeCells('B2:AK3');
        $sheetActive->getStyle('B2:AK3')->applyFromArray( $styleArray1);
        $colCZ = range('C', 'Z');
        $i =5;
        for ($j=0; $j <=23 ; $j++) {
            $sheetActive->getStyle($colCZ[$j] . $i)->applyFromArray($styleArray);
        }

        $colAAAK = range('A', 'K');
        for ($j=0; $j <=10 ; $j++) {
            $sheetActive->getStyle('A' . $colAAAK[$j] . $i)->applyFromArray($styleArray);
        }


        // Rename sheet
        $objWorkSheet->setTitle("Coupang");
        ...
        $objPHPExcel->getActiveSheet($sheetType)->getColumnDimension('Z')->setWidth(15);
        $objPHPExcel->setActiveSheetIndex($sheetType)
            ->setCellValue('B2' , self::$_language['l_listproduct81'])
            ->setCellValue('B' . $i, 'NO')
            ->setCellValue('C' . $i, self::$_language['l_listproduct57'])
            ->setCellValue('D' . $i, self::$_language['l_listproduct58'])
            ->setCellValue('E' . $i, self::$_language['l_listproduct59'])
            ->setCellValue('F' . $i, self::$_language['l_listproduct60'])
            ->setCellValue('G' . $i, self::$_language['l_listproduct61'])
            ->setCellValue('H' . $i, self::$_language['l_listproduct62'])
            ->setCellValue('I' . $i, self::$_language['l_listproduct63'])
            ->setCellValue('J' . $i, self::$_language['l_listproduct64'])
            ->setCellValue('K' . $i, self::$_language['l_listproduct65'])
            ->setCellValue('L' . $i, self::$_language['l_listproduct21'])
            ->setCellValue('M' . $i, self::$_language['l_listproduct67'])
            ->setCellValue('N' . $i, self::$_language['l_listproduct68'])
            ->setCellValue('O' . $i, self::$_language['l_listproduct69'])
            ->setCellValue('P' . $i, self::$_language['l_listproduct70'])
            ->setCellValue('Q' . $i, self::$_language['l_listproduct71'])
            ->setCellValue('R' . $i, self::$_language['l_listproduct72'])
            ->setCellValue('S' . $i, self::$_language['l_listproduct73'])
            ->setCellValue('T' . $i, self::$_language['l_listproduct74'])
            ->setCellValue('U' . $i, self::$_language['l_listproduct75'])
            ->setCellValue('V' . $i, self::$_language['l_listproduct76'])
            ->setCellValue('W' . $i, self::$_language['l_listproduct77'])
            ->setCellValue('X' . $i, self::$_language['l_listproduct78'])
            ->setCellValue('Y' . $i, self::$_language['l_listproduct79'])
            ->setCellValue('Z' . $i, self::$_language['l_listproduct80']);

        $sheetActive->mergeCells('B2:Z3');
        $sheetActive->getStyle('B2:Z3')->applyFromArray( $styleArray1);
        $colCZ = range('C', 'Z');
        $i =5;
        for ($j=0; $j <=23 ; $j++) {
            $sheetActive->getStyle($colCZ[$j] . $i)->applyFromArray($styleArray);
        ...
        // Rename sheet
        $objWorkSheet->setTitle("WMP");

        // Gmarket-Auction channels
        $i = 5;
        $sheetType = 2;
        $objWorkSheet = $objPHPExcel->createSheet($sheetType); //Setting index when creating
        $sheetActive = $objPHPExcel->setActiveSheetIndex($sheetType);
        ...
        $objPHPExcel->setActiveSheetIndex($sheetType)
            ->setCellValue('B2' , self::$_language['l_listproduct97'])
            ->setCellValue('B' . $i, 'NO')
            ->setCellValue('C' . $i, self::$_language['l_listproduct21'])
            ->setCellValue('D' . $i, self::$_language['l_listproduct82'])
            ->setCellValue('E' . $i, self::$_language['l_listproduct83'])
            ->setCellValue('F' . $i, self::$_language['l_listproduct84'])
            ->setCellValue('G' . $i, self::$_language['l_listproduct85'])
            ->setCellValue('H' . $i, self::$_language['l_listproduct86'])
            ->setCellValue('I' . $i, self::$_language['l_listproduct87'])
            ->setCellValue('J' . $i, self::$_language['l_listproduct88'])
            ->setCellValue('K' . $i, self::$_language['l_listproduct89'])
            ->setCellValue('L' . $i, self::$_language['l_listproduct90'])
            ->setCellValue('M' . $i, self::$_language['l_listproduct91'])
            ->setCellValue('N' . $i, self::$_language['l_listproduct92'])
            ->setCellValue('O' . $i, self::$_language['l_listproduct93'])
            ->setCellValue('P' . $i, self::$_language['l_listproduct94'])
            ->setCellValue('Q' . $i, self::$_language['l_listproduct95'])
            ->setCellValue('R' . $i, self::$_language['l_listproduct96']);

        $sheetActive->mergeCells('B2:R3');
        $sheetActive->getStyle('B2:R3')->applyFromArray( $styleArray1);
        $colCR = range('C', 'R');
        $i =5;
        for ($j=0; $j <=15 ; $j++) {
            $sheetActive->getStyle($colCR[$j] . $i)->applyFromArray($styleArray);
        }

        // Rename sheet
        $objWorkSheet->setTitle("Gmarket-Auction");
        ...
        $objPHPExcel->setActiveSheetIndex($sheetType)
            ->setCellValue('B2' , self::$_language['l_listproduct113'])
            ->setCellValue('B' . $i, 'NO')
            ->setCellValue('C' . $i, self::$_language['l_listproduct21'])
            ->setCellValue('D' . $i, self::$_language['l_listproduct99'])
            ->setCellValue('E' . $i, self::$_language['l_listproduct100'])
            ->setCellValue('F' . $i, self::$_language['l_listproduct101'])
            ->setCellValue('G' . $i, self::$_language['l_listproduct102'])
            ->setCellValue('H' . $i, self::$_language['l_listproduct103'])
            ->setCellValue('I' . $i, self::$_language['l_listproduct104'])
            ->setCellValue('J' . $i, self::$_language['l_listproduct105'])
            ->setCellValue('K' . $i, self::$_language['l_listproduct106'])
            ->setCellValue('L' . $i, self::$_language['l_listproduct107'])
            ->setCellValue('M' . $i, self::$_language['l_listproduct108'])
            ->setCellValue('N' . $i, self::$_language['l_listproduct109'])
            ->setCellValue('O' . $i, self::$_language['l_listproduct110'])
            ->setCellValue('P' . $i, self::$_language['l_listproduct111'])
            ->setCellValue('Q' . $i, self::$_language['l_listproduct112']);

        $sheetActive->mergeCells('B2:Q3');
        $sheetActive->getStyle('B2:Q3')->applyFromArray( $styleArray1);
        $colCQ = range('C', 'Q');
        $i =5;
        for ($j=0; $j <=14 ; $j++) {
            $sheetActive->getStyle($colCQ[$j] . $i)->applyFromArray($styleArray);
        }


        // Rename sheet
        $objWorkSheet->setTitle("Naver");
...
//                             }
    ...
    // Đọc nội dung file Excel nhà cung cấp từ dòng 2 trở đi
    public function readuploadProduct( $pathFile, $sheet = 0 ){
        require_once PATH_PLUGINS.'PHPExcel/PHPExcel/IOFactory.php';
        try {
            $inputFileType = PHPExcel_IOFactory::identify( $pathFile );
            $objReader = PHPExcel_IOFactory::createReader($inputFileType);
        ...
        $columnExcel=$this->createColumnsArray( $sheetActive->getHighestColumn());
        //$columnExcel = range('A',  $sheetActive->getHighestColumn());
        // Biến lưu giá trị
        $data = $columnValue = array();
        $success = true;
    ...
    // Đọc nội dung file Excel đăng ký sản phẩm từ dòng 2 trở đi
    public function readuploadProductS11ST( $pathFile, $sheet = 0 ){
        require_once PATH_PLUGINS.'PHPExcel/PHPExcel/IOFactory.php';
        try {
            $inputFileType = PHPExcel_IOFactory::identify( $pathFile );
            $objReader = PHPExcel_IOFactory::createReader($inputFileType);
    ...
    // Đọc nội dung file Excel đăng ký sản phẩm từ dòng 5 trở đi
    public function readUploadProductGmarket( $pathFile, $sheet = 0 ){
        require_once PATH_PLUGINS.'PHPExcel/PHPExcel/IOFactory.php';
        try {
            $inputFileType = PHPExcel_IOFactory::identify( $pathFile );
            $objReader = PHPExcel_IOFactory::createReader($inputFileType);
        ...
        while ( $sheetActive->getCell('C'. $row)->getValue() != '' ){
            ...
            if($row >= 5){
                $rowValue = array();
                foreach ($columnExcel as $col){
                    if ($sheetActive->getCell('C'. $row)->getValue() != '') {
                        $value = $sheetActive->getCell($col . $row)->getValue();
                        $rowValue[$col] = $value;
                    }
                }  
