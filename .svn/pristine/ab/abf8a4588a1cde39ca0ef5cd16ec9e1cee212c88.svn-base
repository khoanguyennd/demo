...
define('URL_BASE'			, SCHEME . URL_HOST .'/phpBidaNew');               			// http://example.com/
...
//define('DB_HOST'	,'mysql:host=eli16.cafe24.com');//		//	 :/cloudsql/klkim-project:asia-northeast1:mysql1 // Đường dẫn host sql
define('DB_HOST'	,'mysql:host=34.64.107.93');
define('DB_USER'	,'cam');										// User sql
define('DB_PWD'		,'5678');											// Password sql
define('DB_NAME'	,'tbbida');								// Tên database
?>