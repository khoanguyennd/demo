...
.chitietthanhvien{padding-top: 15px;}
.chitietthanhvien_icon i {background: #9599b8;padding: 12px 14px;border-radius: 50%;font-size: 24px; border: 1px solid #fff;float: left;margin-right: 10px;}
.chitietthanhvien p{margin-bottom: 0px;}
.rows_tk{background: #011b43;width: 33%;margin-right: 1px;margin-left: 1px;margin-bottom: 2%;text-align: center; padding: 10px 5px; color: #ccc;}
.rows_tk_title{font-weight: bold; padding-bottom: 5px;height: 23px;overflow: hidden;}
...
<?php
    $totalTrandau1 = ($thanhvien1['total_thang'] + $thanhvien1['total_thua']) > 0 ? ($thanhvien1['total_thang'] + $thanhvien1['total_thua']) : 1;
?>
<div class="modal fade" id="chitietthanhvien" tabindex="-1" role="dialog" aria-labelledby="chitietthanhvien" aria-hidden="true">
            ...
            <div class="chitietthanhvien"> 
                <div class="row paddingleftright">
                    ...
                    <div class="col" style="text-align: right;">
                        <p style="padding-top: 5px;"><span><?=$this->language("l_point")?>: </span><span class="colordefault"><?=$thanhvien1['diem']?></span></p>
